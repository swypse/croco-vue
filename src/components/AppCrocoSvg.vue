<template>
	<div class="AppCrocoSvg">
		<svg version="1.1"
			...
			<g :class="cssClass" style="transform-origin:center center;">
				...
				<text class="svg-word" transform="matrix(1 0 0 1 488.8423 461)">
					{{content}}
				</text>
			</g>
		</svg>
...
<script>
  ...
  export default {
    ...
    computed: {
      content: function () {
        return this.currentWord ? this.currentWord.content : ''
      },
      cssClass: function () {
        return this.loading ? 'animated rubberBand' : 'animated'
      },
      ...mapGetters(['currentWord', 'loading'])
    }
  }
</script>
